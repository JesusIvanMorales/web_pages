  ...
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
    ...
    <body class="body1" id="body">
        ...
        <nav class="navbar navbar-expand-lg bg-primary" id="navbar_container">
          <div class="container">
            <h1 class="rounded-3 text-light fw-bold mx-5 ">Acerca De</h1>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <a class="btn btn-light py-1 rounded-3 shadow-lg mx-1 my-3" href="../../index.php " id="go_back">
          ...
          <div class="container text-light" id="text_color">
              ...
              <div class="row m-3 fs-5">
                ...
                <div class="col-12 col-lg-6 mb-3">
                  <h2 class="fw-bolder text-capitalize text-primary mb-5 fs-1">¿Quiénes Somos?</h2>
                ...
                <div class="col-12 mb-3">
                  <h2 class="fw-bolder text-capitalize text-primary text_tittle mb-5">Bibliografías</h2>
                </div>
                ...
                <div class="col-12 mb-3">
                  <h2 class="fw-bolder text-capitalize text-primary mb-5 fs-1">¿Deseas contactarnos?</h2>
                  <h4 class="text-dark fs-4">Llamanos al...</h4>
                  <h4 class="text-dark fs-4">+1 (618) 625-8313</h4>
                  <h4 class="text-dark fs-4">ó bien, madanos un correo:</h4>
                    ...
                    <div class="col-6">
                      <form class="text-center was-validated" novalidate id="envioCorreo">
                        ...
                        <div class="input-group mb-3">
                          ...
                          <input type="email" class="form-control" name="correo" id="correo" placeholder="Correo" aria-label="Correo" aria-describedby="basic-addon1" pattern="[a-z A-Z @ . _ 0-9]*" minlength="7" required>
                        </div>
                        ...
                        <input class="form-control d d-none" type="date" id="fecha" name="fecha"/>
        ...
        <!-- Conexion con js -->
        <script src="../../js/acercade_app.js"></script>
